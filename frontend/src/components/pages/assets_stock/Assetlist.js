...
const HouseAssetList = () => {
  ...
  const handleGoBack = () => {
    navigate(-1); // React Router v6 back
  };

  const filteredHouseAssetList = houseAssetList.filter(
        ...
        <div className="ms-panel ms-panel-fh">
          <div className="ms-panel-body">
            ...
            <table className="table-container">
              ...
              <tbody>
                {filteredHouseAssetList.map((asset) => (
                  <tr className="table-row" key={asset.id}>
                    ...
                    <td className="table-cell">
                      {asset.recorded_by_first_name} {asset.recorded_by_last_name}
                    </td>
                    <td className="table-cell">
