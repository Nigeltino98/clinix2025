...
const Addform = () => {
    ...
    const handleSubmit = (event) => {
        ...
        formData.append('home_id', state.home);
                ...
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                    <Row>
                        ...
                        <Form.Group as={Col} md="6" className="mb-3">
                            ...
                            {errors.national_id && errors.national_id.map(err => (
                                <p key={err} className="ms-text-danger">{err}</p>
                            ))}
                            <Form.Control
                                name="national_id"
                        ...
                        <Form.Group as={Col} md="6" className="mb-3">
                            ...
                            {errors.NHS_number && errors.NHS_number.map(err => (
                                <p key={err} className="ms-text-danger">{err}</p>
                            ))}
                            <Form.Control
                                name="NHS_number"
                        ...
                        <Form.Group as={Col} md="6" className="mb-3">
                            ...
                            {errors.date_of_admission && errors.date_of_admission.map(err => (
                                <p key={err} className="ms-text-danger">{err}</p>
                            ))}
                            <Form.Control
                                type="date"
                        ...
                        <Form.Group as={Col} md="6" className="mb-3">
                            ...
                            {errors.clinical_diagnosis && errors.clinical_diagnosis.map(err => (
                                <p key={err} className="ms-text-danger">{err}</p>
                            ))}
                            <Form.Control
                            ...
                            <Form.Group as={Col} md="6" className="mb-3">
                                ...
                                {errors.marital_status && errors.marital_status.map(err => (
                                    <p key={err} className="ms-text-danger">{err}</p>
                                ))}
                                <Form.Select
                                    name="marital_status"
                            ...
                            <Form.Group as={Col} md="6" className="mb-3">
                                ...
                                {errors.home && errors.home.map(err => (
                                    <p key={err} className="ms-text-danger">{err}</p>
                                ))}
                                <Form.Select
                                    name="home"
                            ...
                            <Form.Group as={Col} md="6" className="mb-3">
                                ...
                                {errors.profile_pic && errors.profile_pic.map(err => (
                                    <p key={err} className="ms-text-danger">{err}</p>
                                ))}
                                <Form.Control
                                    type="file"
