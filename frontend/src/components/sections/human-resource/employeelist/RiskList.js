...
const Addform = () => {
  ...
  const columns = [
  {
    ...
    sortable: true,
    cell: row => (
      <Link to="#" onClick={() => handleShowDetails(row.id)}>
        {row.title}
      </Link>
    ),
  },
  {
    name: 'Staff',
    sortable: true,
    cell: row => selectedStaff(row.created_by, staff),
  },
  {
    name: 'Resident',
    sortable: true,
    cell: row => selectedResident(row.resident, residents),
  },
  {
    name: 'Identified Risk/s',
    sortable: true,
    selector: row => row.identified_risk || '',
  },
  {
    name: 'People at risk',
    sortable: true,
    cell: row => getAtRiskNames(row.at_risk || []),
  },
  {
    name: 'Support Needs',
    sortable: true,
    selector: row => row.support_needs || '',
  },
  {
    name: 'Info Sources',
    sortable: true,
    selector: row => row.information_sources_used || '',
  },
  {
    name: 'Action',
    cell: row => (
    ...
    <div className="ms-panel">
      ...
      <div className="ms-panel-body">
        <div className="thead-primary datatables">
          <DataTable
            columns={columns}
            data={Array.isArray(risks) ? risks : []}
            pagination
            responsive
            striped
            noHeader
